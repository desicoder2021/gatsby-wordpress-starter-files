...
function tango_brand_alliance_setup() {
	 ...
	 * to change 'bookworm' to the name of your theme in all the template files.
	 */
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'bookworm' ),
	) );
...
function tango_brand_alliance_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bookworm' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'bookworm' ),
...
function tango_brand_alliance_scripts() {
	...
	wp_enqueue_script( 'bookworm-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'bookworm-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
