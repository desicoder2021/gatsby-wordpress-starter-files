...
<div class="col-md-3 tango-page-sidebar">
	<aside id="secondary" class="widget-area" role="complementary">
		...
		<?php if (has_children() or $post->post_parent) { ?>
			...
			<?php } ?>
				<img style="float:left; padding:0 10px 0 0" src="/wp-content/themes/bookworm/img/tango-page-icon.svg">
			<?php
			if($post->post_parent):?>
		...
		<?php } else { ?> 
			<ul class="tango-sidebar-menu tango-page-sidebar-text">
				<img style="float:left; padding:0 10px 0 0; width:38px; height:auto" src="/wp-content/themes/bookworm/img/tango-mail-icon.svg">
				<li class="sidebar-menu-header">Mailing list</li>
			</ul>
		
				<p style="font-size:16px; line-height:22px">Do you want to get updates and news from Bookworm!? Send us your email and name to: <a href="mailto:bookworm@bookworm.fiction">bookworm@bookworm.fiction.</a></p>
